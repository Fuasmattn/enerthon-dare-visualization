		...
		<div className="d-flex flex-row" style={{width: '150px', height: '100px'}}>
			<svg width="100%" height="100%" viewBox="0 0 150 100">
				<svg width="100%" height={LINE_HIGHT + "px"} viewBox="0 0 150 10" y="0">
					...
					<text x="75" y="10" fontSize={FONT_SIZE + "px"}>{max_power.toFixed(1)} MW</text>
				</svg>
				...
				<svg width="100%" height={LINE_HIGHT + "px"} viewBox="0 0 150 10" y="88">
					...
					<text x="75" y="10" fontSize={FONT_SIZE + "px"}>{min_power.toFixed(1)} MW</text>
				</svg>

				<motion.svg width="100%" height={LINE_HIGHT + "px"} viewBox="0 0 150 10" animate={{y: istPercents - LINE_HIGHT / 2}} initial={{y:0}}>
					<line x1="0" y1="5" x2="70" y2="5" stroke="black" strokeWidth="3px"/>
					{displayIst && (
						<text x="75" y="10" fontSize={FONT_SIZE + "px"}>{state.ist.toFixed(1)} MW</text>
					)}
				</motion.svg>
				...
				{displayPlusText && (
					<motion.text x="65" fontSize={FONT_SIZE + "px"} textAnchor="end" animate={{y: istPercents - 3}} initial={{y:0}}>
				...
				{displayMinusText && (
					<motion.text x="65" fontSize={FONT_SIZE + "px"} textAnchor="end" dominantBaseline="hanging" animate={{y: istPercents + 3}}>
